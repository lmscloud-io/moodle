...
class core_course_category implements renderable, cacheable_object, IteratorAggregate {
    ...
    public function get_plugins_callback_function(string $name) : array {
        // Mdlcode callback-todo this is a callback invokation function
        $pluginfunctions = [];
     ...
     *
     * @param array $permissionstocheck {Mdlcode-variant-capability} The value can be create, manage or any specific capability.
     * @return bool
     */
