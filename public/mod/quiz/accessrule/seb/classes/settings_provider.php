...
class settings_provider {
    ...
    public static function get_seb_config_elements(): array {
        return [
            ...
            'seb_allowscreencapture' => 'selectyesno',
            'seb_alloweddisplaysmaxnumber' => 'text',
    ...
    public static function get_seb_config_element_types(): array {
        return [
            ...
            'seb_allowscreencapture' => PARAM_BOOL,
            'seb_alloweddisplaysmaxnumber' => PARAM_INT,
    ...
    public static function get_seb_config_element_defaults(): array {
        return [
            ...
            'seb_allowscreencapture' => 0,
            'seb_alloweddisplaysmaxnumber' => 1,
            'seb_muteonstartup' => 0,
