...
export default class Audio extends BaseClass {
    ...
    static getModalClass() {
        return class extends Modal {
            ...
            // Mdlcode-todo assume/use: AudioModal.TEMPLATE 'tiny_recordrtc/audio_recorder'
    ...
    async prepareBlobForOutput() {
        ...
        try {
            ...
            await addToast(message, {type: 'error', delay: 6000});
