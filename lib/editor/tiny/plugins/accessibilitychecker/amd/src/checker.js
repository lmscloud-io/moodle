...
// Mdlcode assume: component 'tiny_accessibilitychecker'
...
export default class {
    ...
    async getAllWarningStrings() {
        const keys = [
            // Mdlcode uses-next-line: string ['emptytext', 'tiny_accessibilitychecker']
            'emptytext',
            // Mdlcode uses-next-line: string ['entiredocument', 'tiny_accessibilitychecker']
            'entiredocument',
            // Mdlcode uses-next-line: string ['imagesmissingalt', 'tiny_accessibilitychecker']
            'imagesmissingalt',
            // Mdlcode uses-next-line: string ['needsmorecontrast', 'tiny_accessibilitychecker']
            'needsmorecontrast',
            // Mdlcode uses-next-line: string ['needsmoreheadings', 'tiny_accessibilitychecker']
            'needsmoreheadings',
            // Mdlcode uses-next-line: string ['tablesmissingcaption', 'tiny_accessibilitychecker']
            'tablesmissingcaption',
            // Mdlcode uses-next-line: string ['tablesmissingheaders', 'tiny_accessibilitychecker']
            'tablesmissingheaders',
            // Mdlcode uses-next-line: string ['tableswithmergedcells', 'tiny_accessibilitychecker']
