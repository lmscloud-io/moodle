...
// Mdlcode assume: component 'tiny_recordrtc'
...
export default class {
    ...
    handleCaptureFailure(error) {
        ...
        this.displayAlert(
            // Mdlcode assume: subject ['gumabort', 'gumnotfound', 'gumnotreadable', 'gumnotallowed', 'gumnotsupported', 'gumoverconstrained', 'gumsecurity', 'gumtype', 'insecurealert', 'norecordingfound', 'nowebrtc']
    ...
    async setRecordButtonTextFromString(string) {
        // Mdlcode assume-next-line: string ['recordagain']
    ...
    async insertMedia(source) {
        const {html} = await Templates.renderForPromise(
            // Mdlcode assume: this.getEmbedTemplateName() ['tiny_recordrtc/embed_video', 'tiny_recordrtc/embed_audio']
            this.getEmbedTemplateName(),
