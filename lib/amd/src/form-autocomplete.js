    ...
    return {
        ...
        enhance: function(selector, tags, ajax, placeholder, caseSensitive, showSuggestions, noSelectionString,
            ...
            var options = {
                ...
                templates: $.extend({
                        // Mdlcode uses-next-line: template 'core/form_autocomplete_input'
                        input: 'core/form_autocomplete_input',
                        // Mdlcode uses-next-line: template 'core/form_autocomplete_selection_items'
                        items: 'core/form_autocomplete_selection_items',
                        // Mdlcode uses-next-line: template 'core/form_autocomplete_layout'
                        layout: 'core/form_autocomplete_layout',
                        // Mdlcode uses-next-line: template 'core/form_autocomplete_selection'
                        selection: 'core/form_autocomplete_selection',
                        // Mdlcode uses-next-line: template 'core/form_autocomplete_suggestions'
